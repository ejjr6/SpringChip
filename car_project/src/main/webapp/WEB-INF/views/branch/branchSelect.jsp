...
//		listPage(page);
	...
	function printList(list){
		...
		$(list).each(function(){
			// BranchVO == this   / bno,bName,bPhone,bAddr,blati,blongti
			var bno = this.bno;
			var bName = this.bname;
			var bPhone = this.bphone;
			var bAddr = this.baddr;
			var blati = this.blati;
			var blongi = this.blongi;
			...
			console.log(blongi);
				...
				str += "&nbsp;&nbsp;&nbsp;<a href='https://map.kakao.com/link/to/"+bName+","+blati+","+blongi+"'>";
				str += "<img src='${path}/resources/place/placeMarker2.png'/>";
				str += "</a>";
				str += "</div>";
				str += "</div>";
				str += "</li>";
